...
# 			file2=${arr[$ind2]}
# 			echo $file1 $file2
# 			outfile="../tr_output/${file1}_${file2}_udp.out"
# 			errorfile="../tr_output/${file1}_${file2}_udp.err"
# 			echo ${outfile}
# 			echo ${errorfile}
# 			echo
# 			sbatch -o ${outfile} -e ${errorfile} run_single.slurm eval_udp_adapters_2 ${file1} ${file2}
# 		fi
# 	done
# done 
